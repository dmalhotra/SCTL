 ...
 *      projection, the singular/near quadrature schemes (adaptive log-singular, rectangular-polar,
 *      hybrid, line-QBX) against closed-form or upsampled references, and the gmsh importer.
...
#include <sctl/experimental/gmsh_reader.cpp>  // gmsh -> QuadElemList importer (test_GmshReader)
#include <iostream>
#include <iomanip>
#include <vector>
#include <string>
...
int main(int argc, char** argv) {
  ...
  using Real = double;
  {
    ...
    // Verify the default high-accuracy params reach deep-near ~1e-10 for a panel-INTERIOR foot,
    // against a RectPolar gold (RP256==RP512 to ~1e-15). d=1e-4, flat plane.
